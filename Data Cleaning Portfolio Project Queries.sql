/*
This is an SQL cleaning data project that involves Nashville Housing Data from many years
...
-- Visualizate the whole information to see with what we are working on
Select *
...
-- If it doesn't Update properly on SQL Server Management Studio use the following lines 
...
-- Breaking out Address into Individual Columns (Address, City, Owner, State)
